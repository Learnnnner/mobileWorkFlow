...
public class EditUser {
    public static void edit(RoutingContext routingContext, Vertx vertx) {
        ...
        if (!StringTool.isEmpty(id) && !StringTool.isEmpty(loginname) && !StringTool.isEmpty(password)) {
            ...
            String sql = "update org_user set loginname = ?, realname = ?, password = ?, telephone = ?, email = ? , enable = ? where id = ?";
            String sqlR = "update org_user_relation set id = ? where userId = ?";
